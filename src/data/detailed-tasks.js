            ...
            prerequisites: [
              {
                type: 'knowledge',
                title: 'URDF vs MJCF',
                content: 'URDF是ROS标准格式，MJCF是MuJoCo格式，需要手动添加MuJoCo特有的元素如tendon、actuator等。'
              }
            ]
          },
          {
            ...
            prerequisites: [
              {
                type: 'knowledge',
                title: '任务设计原则',
                content: '好的RL任务应该：目标明确、可观测、可训练、有明确成功标准、考虑安全约束。'
              }
            ]
          }
        ]
            ...
            prerequisites: [
              {
                type: 'knowledge',
                title: 'CANFD协议',
                content: 'CAN FD是CAN的扩展，支持更高数据率和更大payload，适合实时控制多个电机。'
              },
              {
                type: 'knowledge',
                title: 'FOC控制',
                content: 'FOC（磁场定向控制）是电机控制技术，提供平滑扭矩和高效能耗，适合精密机器人应用。'
              }
            ]
          }
        ]
